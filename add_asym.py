# Script to add estimates with asymmetrical uncertainties.
# NOTE: We did not write this code. It comes from 
# https://github.com/anisotropela/add_asym/tree/master, a package by Peter Laursen.
